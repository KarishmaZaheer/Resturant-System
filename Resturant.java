...
public class Resturant extends JFrame{
	...
	private static ResturantListLabel waitingCustomerLabel;
	private static ResturantListLabel seatedCustomerLabel;
	private static ResturantListLabel servedCustomerLabel;
	...
	public Resturant() {
		...
		waitingCustomerLabel = new ResturantListLabel("Waiting Customers: ", labelLock);
		seatedCustomerLabel  = new ResturantListLabel("Seated Customers: ", labelLock);
		servedCustomerLabel  = new ResturantListLabel("Served Customers: ", labelLock);
